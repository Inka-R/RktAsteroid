...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |ASTEROIDS FINAL|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(require 2htdp/image)
...
(define-struct (heat-seeker missile)
  ...
  #:methods
  (define (update! m)
    (set-game-object-velocity! m
                               (posn-* 15
                                       (heading-of (closest-asteroid-to m)
                                                   m))))
...
(define-struct (ufo game-object)
  ...
  (define (update! u)
    (set-game-object-velocity! u
                               (posn-* 15 (heading-of the-player u))))
